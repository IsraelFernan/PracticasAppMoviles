...
public class MainActivity extends AppCompatActivity
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      if (savedInstanceState == null &&
         findViewById(R.id.constraintLayout) != null) {
         ...
         transaction.add(R.id.constraintLayout, contactsFragment);
   ...
   public void onContactSelected(Uri contactUri) {
      if (findViewById(R.id.constraintLayout) != null) // phone
         displayContact(contactUri, R.id.constraintLayout);
      else { // tablet
   ...
   public void onAddContact() {
      if (findViewById(R.id.constraintLayout) != null) // phone
         displayAddEditFragment(R.id.constraintLayout, null);
      else // tablet
   ...
   public void onEditContact(Uri contactUri) {
      if (findViewById(R.id.constraintLayout) != null) // phone
         displayAddEditFragment(R.id.constraintLayout, contactUri);
      else // tablet
   ...
   public void onAddEditCompleted(Uri contactUri) {
      ...
      if (findViewById(R.id.constraintLayout) == null) { // tablet
         // removes top of back stack
         getSupportFragmentManager().popBackStack();
